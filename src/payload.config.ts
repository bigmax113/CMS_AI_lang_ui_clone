...
const plugPlayDemoImages: Record<string, string> = {
  ...
  'PlugPlay_750x350-2.jpg': '/lorgar-figma/card-fallbacks/card-01.webp',
  'PlugPlay_750x350-3.jpg': '/lorgar-figma/card-fallbacks/card-06.webp',
}
...
const ensureArticleViewCountSchema = async () => {
  ...
  try {
    const enumValuesByType: Record<string, string[]> = {
    ...
    const enumTypeResult = await client.query<{ schema_name: string; type_name: string }>(
      `
    ...
    const enumStatements = enumTypeResult.rows
      .flatMap((row) => {
        const enumSchema = quoteDatabaseIdentifier(row.schema_name)
        const enumType = quoteDatabaseIdentifier(row.type_name)
...
const seedMediaDefinitions = [
  ...
  },
  {
    ...
    externalImageURL: '/lorgar-figma/card-fallbacks/card-07.webp',
    filename: 'lorgar-rankings-cover.webp',
    mimeType: 'image/webp',
  },
  {
    alt: 'LORGAR product detail close-up',
    externalImageURL: '/lorgar-figma/card-fallbacks/card-06.webp',
    filename: 'lorgar-product-closeup-1.webp',
    mimeType: 'image/webp',
  },
  {
    alt: 'LORGAR product and audience showcase',
    externalImageURL: '/lorgar-figma/card-fallbacks/card-01.webp',
    filename: 'lorgar-platform-cover.webp',
    mimeType: 'image/webp',
  },
] as const
...
const seedArticleDefinitions = [
  {
    ...
    contentType: 'news',
    coverImageKey: 'lorgar-rankings-cover.webp',
    languageCode: 'en',
  ...
  },
  {
    ...
    category: 'release-note',
    contentType: 'news',
    coverImageKey: 'lorgar-platform-cover.webp',
    languageCode: 'en',
  ...
  },
  {
    ...
    contentType: 'guide',
    coverImageKey: 'lorgar-product-closeup-1.webp',
    languageCode: 'en',
